...
class AMVKitTests: XCTestCase {
    ...
    var accessCertificateJSON: Data?
    let certificateUUID = UUID().uuidString
    
    override func setUp() {
        super.setUp()
        createTestAccessCertificate()
    }
    
    func createTestAccessCertificate() {
        // valid from 2018-04-05 10:06 until 2018-04-13 10:04
        accessCertificateJSON =
            """
                {
                "id": "\(certificateUUID)",
                "name" : "Test",
    ...
    func test_itShouldCreateValidAccessCertificate() {
        createTestAccessCertificate()
    }
