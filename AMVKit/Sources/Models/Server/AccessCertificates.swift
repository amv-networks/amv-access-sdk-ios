...
public struct AccessCertificate {
    ...
    let vehicleCertificate: HMKit.AccessCertificate
}
...
extension AccessCertificate: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard let deviceCert = HMKit.AccessCertificate(base64Encoded: deviceValue) else {
            throw Failure.invalidData
        }

        guard let vehicleCert = HMKit.AccessCertificate(base64Encoded: vehicleValue) else {
            throw Failure.invalidData
        }
